...
const features=[
  ...
  },
  {
    ...
    description:
      "Our Intelliogent chatbot remembers previous interactions, providing a seamless and personalized experience.",
    icon:BrainCogIcon
  },
  {
...
export default function Home() {
  return (
    <main className="flex-1 overflow-auto p-2 lg:m-3 lg:p-5 bg-gradient-to-bl from-white to-indigo-600">
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl m-0">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto mx-w-2xl sm:text-center">
            <h2 className="text-base font-semibold leading-7 text-indigo-700">Your Interactive Document Companion</h2>
            <p className="mt-2 font-bold text-3xl tracking-tight text-gray-900 sm:text-5xl">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <br />
              <br />
              Upload your document, and our chatbot will answer questions,summarize content, and answer all your Qs.
              Ideal for everyone.<span className="text-indigo-700">
                Chat with PDF.
              </span>{" "}
              ...
              {features.map(feature=>(
                <div key={feature.name} className="relative">
                  <dt className="inline font-semibold text-gray-900">
                    <feature.icon 
                      aria-hidden="true"
                      className="absolute left-1 top-1 h-5 -5 text-indigo-600"
                    />
                  </dt>
                  <dd className="pl-14">
                  {feature.description}
